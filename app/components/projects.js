...
export default function About() {
    ...
    return (
        <div id="projects" className="h-screen w-full flex flex-col items-left sm:justify-center ">
            <div className="font-bold text-8xl text-center">Projects</div>
            <div className="text-lg mr-96 my-4">Hi! I’m Kai Sheng, a second-year Software Engineering student at SMU. 
